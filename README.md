...
- The vast majority of the files in this github are from the template repo and can essentially be ignored
...
Based on the Github Pages template for academic websites. This was forked (then detached) by [Stuart Geiger](https://github.com/staeiou) from the [Minimal Mistakes Jekyll Theme](https://mmistakes.github.io/minimal-mistakes/), which is © 2016 Michael Rose and released under the MIT License. See LICENSE.md.Then it was forked and detached by members of PUPS research lab.
